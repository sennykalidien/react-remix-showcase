...
function FlightsSearch({ initialFocus = false }: FlightSearchProps) {
  ...
  return (
    <form onSubmit={handleSubmit}>
      <div>
        <TextField id="search" name="search" type="search" placeholder="Enter the airport destination" className="w-full border-s-2 border-amber-900" defaultValue={value} onChange={handleChange} hasError={!!error} autoFocus={initialFocus} />
