  ...
  return (
    <html lang="en">
      ...
      <body>
        <header>
          <AppBar>
            <div className="container mx-auto py-2 flex items-center justify-between">
              <NavLink to="/">
                <Logo className="m-auto md:m-0 w-32" aria-hidden="true" focusable={'false'} />
              </NavLink>
              <Nav>
                <NavItem>
                  <NavLink to="/flights" className="link">
                    All Flights
                  </NavLink>
                </NavItem>
              </Nav>
        ...
        <main>
          <FlightsContextProvider>{children}</FlightsContextProvider>
        </main>
        <ScrollRestoration />
        <Scripts />
      </body>
